  ...
  <DashboardLayout>
    <template #header>
      <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
          <router-link to="/sales/quotation/new" class="btn btn-primary">
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><router-link :to="`/sales/quotation/${quotation.id}/edit`" class="dropdown-item">
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <router-link :to="`/sales/quotation/${selectedQuotation?.id}/edit`" class="btn btn-primary">
              Editar cotización
            </router-link>
          </div>
        </div>
